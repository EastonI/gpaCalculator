# This is my Weighted GPA Calculator Subalgorithm (WGPA)
...
def wgpa():
    ...
    if numOfClasses == 4 and honorsClasses == "Yes":
    ...
    elif numOfClasses == 4 and honorsClasses == "yes":
    ...
    elif numOfClasses == 6 and honorsClasses == "Yes":
    ...
    elif numOfClasses == 4 and honorsClasses == "No":
    ...
    elif numOfClasses == 6 and honorsClasses == "No":
